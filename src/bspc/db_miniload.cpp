...
#define INVALID_DBFILE -1
	...
	void(__cdecl *DB_RemoveXAssetHandler[33])(void *head) = { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL,
		&DB_RemoveLoadedSound, &DB_RemoveClipMap, &DB_RemoveClipMap, &DB_RemoveComWorld, NULL, NULL, NULL, NULL, NULL,
	...
	const char *g_defaultAssetName[] = { "", "default", "void", "void", "$default", "default", "$white", "null",
		"default", "null.wav", "", "", "", "", "", "", "", "light_dynamic", "", "fonts/consolefont", "ui/default.menu",
		"default_menu", "CGAME_UNKNOWN", "defaultweapon_mp", "", "misc/missing_fx", "default", "", "", "", "", "" };
...
extern "C"
{
	...
	XAssetEntryPoolEntry *__cdecl DB_CreateDummyEntry(XAssetType type, const char *name)
	{
		...
		if (db_xassetdebug)
		{
			...
			if (db_xassetdebugtype == -1 || db_xassetdebugtype == type || (debugname[0] && !Q_stricmp(name, debugname)))
			{
	...
	void __cdecl DB_DelayedCloneXAsset(XAssetEntry *newEntry)
	{
		...
		if (g_sync)
		{
			if (db_xassetdebug)
			{
				...
				if (db_xassetdebugtype == -1 || db_xassetdebugtype == newEntry->asset.type
